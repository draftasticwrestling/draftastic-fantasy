...
export async function GET() {
  // Schema-safe query: some environments expose only "Status" (capital S), not status.
  // Keep this endpoint simple (all wrestlers sorted) and let callers apply their own filters.
