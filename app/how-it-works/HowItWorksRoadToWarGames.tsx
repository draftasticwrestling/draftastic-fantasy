    ...
    <>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ marginBottom: 12, lineHeight: 1.65, color: "#333" }}>
          For <strong>Road to War Games</strong> leagues with <strong>3–6 factions</strong> (current beta sizing), roster
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <p style={{ marginBottom: 16, color: "#555" }}>
          Main roster PLE details for Road to War Games will be added here.
        </p>
      </section>
      ...
      <HowItWorksNxtScoring
        sectionContext={
          <>
            This scoring profile is used for <strong>Road to War Games</strong> leagues when{" "}
            <strong>Include NXT</strong> is enabled.
          </>
        }
        beltContext={
          <>
            For <strong>Road to War Games</strong> leagues when <strong>Include NXT</strong> is enabled.
          </>
        }
      />
