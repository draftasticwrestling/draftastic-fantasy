...
export const metadata = {
  title: `${EXAMPLE_LEAGUE.name} — Draftastic Fantasy`,
  ...
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", padding: 24, maxWidth: 960, margin: "0 auto", fontSize: 18, lineHeight: 1.6 }}>
      ...
      <p style={{ color: "#555", marginBottom: 32 }}>
        Team pages for each league member. Rosters and points will appear here after the draft and when event scoring is run.
      </p>
