...
export default async function WrestlerProfilePage({
  ...
  const [reignsResult, tagTeamResult, currentFromTable, currentFromChanges] = await Promise.all([
  ...
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", padding: 24, maxWidth: 900, margin: "0 auto", fontSize: 16, lineHeight: 1.5 }}>
      ...
      <WrestlerProfileEventsPanel
        ...
        matchTimelineEvents={allEvents as { id: string; name?: string | null; date?: string | null; location?: string | null; status?: string | null; matches?: unknown }[]}
