...
export function MarketingLandingCopy({
  ...
  sidebar: ReactNode;
  /** Set false on About Us when the top hero (title + signup) should be omitted. */
  showHero?: boolean;
}) {
  return (
    <>
        ...
        <section className="cs-hero">
          <div className="cs-hero-inner">
            ...
            <p className="cs-hero-sub">
              Draft your roster. Track every match. Compete with friends and turn every episode of wrestling into a fantasy
              battle.
            </p>
        ...
        <div className="cs-landing-main">
          <section className="cs-section">
            <div className="cs-section-inner">
              ...
              <p>
                Millions of fans tune in every week to watch professional wrestling. The drama. The rivalries. The moments
                that make you jump off the couch.
              </p>
              <p>So we had a question.</p>
              <p>
                <strong>Why isn&apos;t Fantasy Pro Wrestling bigger?</strong>
              </p>
              <p>Fantasy football makes every Sunday game matter. Fantasy baseball turns stats into strategy.</p>
          ...
          <section className="cs-section">
            <div className="cs-section-inner">
              ...
              <p>
                Three longtime wrestling fans attended their first WWE event in over twenty years… and suddenly we were
              ...
              <p>
                Draftastic started as a spreadsheet, a scoring system, and a group of friends who suddenly cared a lot about
                what happened on RAW, SmackDown, and every Premium Live Event. The more we refined the league, the more
                invested we became. Soon we weren&apos;t just watching wrestling again.
              </p>
              ...
              <p>
                <strong>It&apos;s competition.</strong>
              </p>
          ...
          <section id="how-it-works" className="cs-section">
            <div className="cs-section-inner">
              ...
              <div className="cs-step-block">
                ...
                <p>
                  Build your dream roster from the current wrestling landscape. Every superstar you draft becomes part of
                  your fantasy stable, earning points based on their performances each week.
                </p>
              ...
              <ol className="cs-steps">
                <li>
                  <strong>2 — Watch the Action</strong>
                  <br />
                  Every match, victory, and performance earns fantasy points.
                </li>
                <li>
                  <strong>3 — Compete for the Championship</strong>
                  <br />
          ...
          <section className="cs-section">
            <div className="cs-section-inner">
              ...
              <p>
                Every match matters. Wins, title changes, and standout performances all impact the leaderboard. Track your
                progress and see who&apos;s dominating the league.
              </p>
              <figure className="cs-inline-screenshot">
                <div className="cs-screenshot-img-wrap">
                    <Image
          ...
          <section className="cs-section">
            <div className="cs-section-inner">
              ...
              <p>
                Track the hottest performers across the wrestling landscape. League leaderboards highlight the superstars
                delivering the most fantasy points, giving you the data you need to make smarter roster moves.
              </p>
              <figure className="cs-inline-screenshot">
                <div className="cs-screenshot-img-wrap">
                    <Image
          ...
          <section className="cs-section">
            <div className="cs-section-inner">
              ...
              <p>
                Each wrestler has a detailed profile showing their fantasy production, stats, and performance trends. Study
                the numbers and build a roster that dominates.
              </p>
              <figure className="cs-inline-screenshot">
                <div className="cs-screenshot-img-wrap">
                    <Image
          ...
          <section className="cs-section cs-final-cta">
            <div className="cs-section-inner">
              ...
              <p>It&apos;s drama. It&apos;s strategy. It&apos;s competition.</p>
              <p>Draftastic turns every episode of wrestling into a game where every match matters.</p>
