 ...
 * @param {string} raw
 * @param {string} eventDate - YYYY-MM-DD (month-end for belt, event day for matches)
 */
...
export function wrestlerMatchesBeltMapKey(wrestlerId, displayName, mapKey, eventDate) {
  return scoringSlugCandidatesForWrestler(wrestlerId, displayName, eventDate).has(mapKey);
}
