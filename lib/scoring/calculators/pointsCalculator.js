...
function calculateSpecialVictoryBonus(match, matchData, eventType, isWinner) {
...
export function calculateMatchPoints(match, event, allMatches, wrestlerName) {
  ...
  const specialVictoryBonus = calculateSpecialVictoryBonus(match, matchData, eventType, isWinner);
