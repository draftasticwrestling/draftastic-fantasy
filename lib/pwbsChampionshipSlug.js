...
export function getPwbsChampionshipPage(titleRaw) {
  ...
  const t = normalizeApostrophes(titleRaw).trim().toLowerCase().replace(/[-_]+/g, " ");
  if (!t) return null;
