...
where (champion_slug = 'drew-mcintyre' or lower(coalesce(champion_name, champion, '')) like '%drew mcintyre%')
...
insert into championship_history (champion_slug, champion_name, champion, title, title_name, won_date, start_date, lost_date, end_date)
values (
  'cody-rhodes',
  'Cody Rhodes',
  'Cody Rhodes',
